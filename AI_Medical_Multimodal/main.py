    ...
    try:
        with open(image_path, "rb") as image_file:
            ...
            try:
                ...
                logger.exception(f"invalid image format: {str(e)}")
            ...
            responses = {}
            for model, response in [("llama11b", llama_11b_response), ("llama_90b", llama_90b_response)]:
        ...
        logger.error(f"An unexpected error while encoding or opening image: {str(e)}")
        return {"error": f"An unexpected error while encoding or opening image: {str(e)}"}

if __name__ == "__main__":
    image_path = "test1.png"
    query = "what are encoders in this picture?"
